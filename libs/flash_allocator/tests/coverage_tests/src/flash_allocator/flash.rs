...
use crate::flash_allocator::FLAG_BYTES;
...
/// to the crate::flash_allocator, this ensures the current crate::flash_allocator is the only that can generate an instance.
