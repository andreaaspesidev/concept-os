...
fn setup_timed_read(
    ...
    usart: &device::usart3::RegisterBlock,
...
fn setup_usart(usart: &device::usart3::RegisterBlock) -> Result<(), RCCError> {
...
fn configure_dma_rx(dma1: &device::dma1::RegisterBlock, usart: &device::usart3::RegisterBlock) {
...
fn dma_receive_to_idle(_: &device::dma1::RegisterBlock, usart: &device::usart3::RegisterBlock) {
...
fn dma_receive_callback(
    ...
    _usart: &device::usart3::RegisterBlock,
) {
    // Something changed?
...
fn step_transmit(usart: &device::usart3::RegisterBlock, state_ref: &mut DriverState) {
