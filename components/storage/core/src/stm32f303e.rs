...
// Size: 512Kb
pub const FLASH_ALLOCATOR_START_ADDR: u32 = 0x0800_0000;
pub const FLASH_ALLOCATOR_END_ADDR: u32 = 0x0800_7FFF;
pub const FLASH_ALLOCATOR_SIZE: usize =
    (FLASH_ALLOCATOR_END_ADDR - FLASH_ALLOCATOR_START_ADDR + 1) as usize; // 0x8000 -> 32768
...
// (even 0 is fine)
pub const FLASH_ALLOCATOR_START_SCAN_ADDR: u32 = 0x0800_1000; // 4Kb reserved to the kernel
...
pub const FLASH_FLAG_SIZE: usize = 2;
...
// pub const FLASH_BLOCK_MAX_LEVEL: u16 = (FLASH_NUM_SLOTS - 1) as u16;
