...
/// This is the entry point for the task, invoked by the kernel.
/// The kernel/app loader is responsible to setup the memory layout for this task,
/// then call this entrypoint. Here some additional setup can be performed,
/// but probably this function will be removed in the future
/// 
#[doc(hidden)]
#[no_mangle]
